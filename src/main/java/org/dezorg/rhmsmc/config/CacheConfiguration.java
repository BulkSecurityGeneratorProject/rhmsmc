package org.dezorg.rhmsmc.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("rhmsmc");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("rhmsmc");
        ...
        config.getMapConfigs().put("org.dezorg.rhmsmc.domain.*", initializeDomainMapConfig(jHipsterProperties));
